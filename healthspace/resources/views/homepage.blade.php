          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 info">
                <i class="bx bx-map"></i>
                <h4>Alamat</h4>
                <p>Jl. PB. Sudirman, Ampo, Dukuh Mencek, Kec. Sukorambi,<br>Jember, 68153</p>
              </div>
              <div class="col-lg-6 info">
              ...
              <i class='bx bxl-instagram'></i>
                <h4>Instagram</h4>
                <p>klinik_fbm_panti</p>
              </div>
              <div class="col-lg-6 info">
                <i class="bx bx-time-five"></i>
                <h4>Jam Kerja</h4>
                <p>Senin - Sabtu<br> Pagi: 07.30 - 14.00 <br>Sore: 14.00 - 20.00</p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Klinik FBM Panti</h3>
            <p>
            Jl. PB. Sudirman, Ampo, Dukuh Mencek, Kec. Sukorambi, <br>
            Jember, 68153<br>
            Jawat Timur <br><br>
              <strong>Phone:</strong> 0812-3419-1646<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a>Unit Gawat Darurat 24 Jam</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Pelayanan Rawat Jalan</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Pelayanan Rawat Inap</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Pelayanan Kesehatan Ibu dan Anak (KIA)</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Pelayanan Khitan/Sunat</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Home Visite</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Ambulance</a></li>
              <li><i class="bx bx-chevron-right"></i> <a>Poli Kecantikan</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              <a href="https://www.instagram.com/klinik_fbm_panti/" class="facebook"><i class="bx bxl-instagram"></i></a>
              <a href="https://www.facebook.com/p/Klinik-Fandaberkatmedika-PANTI-100077316975318/" class="instagram"><i class="bx bxl-facebook"></i></a>
            </div>
          </div>
